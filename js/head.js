...
window.Modernizr = (function(window, document, undefined) {
    ...
    function testPropsAll(prop, prefixed) {
        ...
        var ucProp = prop.charAt(0)
            ...
            props = (prop + ' ' + domPrefixes.join(ucProp + ' ') + ucProp)
                .split(' ');
    ...
    /*>>csstransforms3d*/
    , ['@media (', prefixes.join('transform-3d),('), mod, ')', '{#csstransforms3d{left:9px;position:absolute}}'].join('') /*>>csstransforms3d*/
    ...
    tests['flexbox'] = function() {
        ...
        function setPrefixedValueCSS(element, property, value, extra) {
            property += ':';
            element.style.cssText = (property + prefixes.join(value + ';' + property))
                .slice(0, - property.length) + (extra || '');
        }
...
result = !!openDatabase( mod + "testdb", "1.0", mod + "testdb", 2e4);
    ...
    tests['cssgradients'] = function() {
        ...
        setCss(
        (str1 + prefixes.join(str2 + str1) + prefixes.join(str3 + str1))
            .slice(0, - str1.length));
            ...
            for (var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++) {
                ...
                if (bool) {
                    ...
                    if (/^range$/.test(inputElemType) && inputElem.style.WebkitAppearance !== undefined) {
                        ...
                        bool = defaultView.getComputedStyle && defaultView.getComputedStyle(inputElem, null)
